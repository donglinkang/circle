...
<div class="wrapper">
  ...
  <div class="cst-shoppingCart">
    <h3>已选购的商品</h3>
    <div class="shopCart">
      <div class="title"><i></i>Only厦门万达店</div>
      <dl>
        <input class="input1" type="checkbox" name="" checked="false">
        <img src="temp/jlb_pr5.jpg">
        <dt>ONLY秋装新品修身短款金属拉链西服外套上衣女T|113333006</dt>

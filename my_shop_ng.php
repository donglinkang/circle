...
<div class="wrapper" style="padding-bottom:1px;">
  ...
  <header class="headBox">
    ...
    <div class="title">内购福利</div>
  </header><!--.headBox end//-->
  
  <ul class="shop_sx">
    <li><a href="my_shop_new.php">新品上架</a></li>
    <li><a href="my_shop_njp.php">热卖精品</a></li>
    <li><a href="my_shop_lm.php">联盟专辑</a></li>
    <li>筛选<i class="saix"></i></li>
  </ul>

  <section class="my_finger_shop">
    <article>春田花花的秋装专区<span>512人己关注<a href="javascript:void(0)">+ 关注</a></span></article>
    <ul>
      <li>
        <a href="javascript:(0);">

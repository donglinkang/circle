...
<div class="wrapper">
    ...
    <ul>
      <li>
        <a href="my_shop_njp.php">
          <span><img src="temp/tn_13.jpg"></span>
          <span><img src="temp/tn_14.jpg"></span>
          <span><img src="temp/tn_15.jpg"></span>
          <span><img src="temp/tn_16.jpg"></span>
          <span><img src="temp/tn_17.jpg"></span>
          <span><img src="temp/tn_18.jpg"></span>
        </a>
      </li>
      <p><span>奢华质感的皮草是每位女性的挚爱，能打造出强大的气场，我们将皮革大胆富有新意的结合...</span><a href="my_shop_njp.php"><b>全部精品</b></a></p>
    </ul>
  </section>
  <!--.my_finger_shop end//-->
  ...
  <section class="my_finger_shop">
    ...
    <ul>
      ...
      <p><span>奢华质感的皮草是每位女性的挚爱，能打造出强大的气场，我们将皮革大胆富有新意的结合...</span><a href="my_shop_ng.php"><b>全部内购</b></a></p>
    </ul>
  </section>
  <!--.my_finger_shop end//-->
  </div><!--指店 end//-->
  ...
  <div>
    ...
    </section><!--.zimeiti_cm end//-->
    <section class="zimeiti_cm margin10">
      <div class="cab_box">
        <ul>
          <li class="cab_box_li"><a href="zhimei_big.php"><img src="temp/t_05_2.jpg"><span>ONLY VIP NIGHT</span></a></li>
          <li>
            <a href="zhimei_big.php">
              <dl>
                <dd><h4>Love Avenue</h4>2014-05-03</dd>
                <dt><img src="temp/t_05_4.jpg"></dt>
              </dl>
            </a>
          </li>
        </ul>
    ...
    <section class="zimeiti_cm margin10">
      <div class="cab_box">
        <ul>
          <li class="cab_box_li"><a href="zhimei_big.php"><img src="temp/t_05_3.jpg"><span>White Heat</span></a></li>
          <li>
            <a href="zhimei_big.php">
              <dl>
                <dd><h4>中秋特享：会员限时双倍积分</h4>2014-05-03</dd>
                <dt><img src="temp/t_05_5.jpg"></dt>
              </dl>
            </a>
          </li>
        </ul>
  ...
  <div class="zbrw_box">
    <div class="rw_list" style="margin-bottom:10px;">
      <dl>
        ...
        <dd><div>安装应用</div><div><!-- <i>1</i>/1 --></div><div>50指币</div><div><a class="rw_e">已完成</a></div></dd>
